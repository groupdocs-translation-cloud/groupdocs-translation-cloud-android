...
public class XmlFileRequest {
  ...
  public XmlFileRequest url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public XmlFileRequest isNeedAlignment(@javax.annotation.Nullable Boolean isNeedAlignment) {
  ...
  public XmlFileRequest translationDictionary(@javax.annotation.Nullable Map<String, String> translationDictionary) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sourceLanguage, xmlFileRequest.sourceLanguage) &&
        ...
        Objects.equals(this.isNeedAlignment, xmlFileRequest.isNeedAlignment) &&
        Objects.equals(this.translationDictionary, xmlFileRequest.translationDictionary) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceLanguage, targetLanguages, originalFileName, url, origin, isNeedAlignment, translationDictionary, savingMode, ignoreList, isWhiteList);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sourceLanguage", "targetLanguages", "originalFileName", "url", "origin", "isNeedAlignment", "translationDictionary", "savingMode", "ignoreList", "isWhiteList"));
