...
public class PdfFileRequest {
  ...
  public PdfFileRequest url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public PdfFileRequest isNeedAlignment(@javax.annotation.Nullable Boolean isNeedAlignment) {
  ...
  public PdfFileRequest translationDictionary(@javax.annotation.Nullable Map<String, String> translationDictionary) {
    this.translationDictionary = translationDictionary;
    return this;
  }

  public PdfFileRequest putTranslationDictionaryItem(String key, String translationDictionaryItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sourceLanguage, pdfFileRequest.sourceLanguage) &&
        ...
        Objects.equals(this.isNeedAlignment, pdfFileRequest.isNeedAlignment) &&
        Objects.equals(this.translationDictionary, pdfFileRequest.translationDictionary) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceLanguage, targetLanguages, originalFileName, url, origin, isNeedAlignment, translationDictionary, savingMode, outputFormat, preserveFormatting, pages);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sourceLanguage", "targetLanguages", "originalFileName", "url", "origin", "isNeedAlignment", "translationDictionary", "savingMode", "outputFormat", "preserveFormatting", "pages"));
