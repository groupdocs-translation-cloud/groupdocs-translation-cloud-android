...
public class CsvFileRequest {
  ...
  public CsvFileRequest url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public CsvFileRequest isNeedAlignment(@javax.annotation.Nullable Boolean isNeedAlignment) {
  ...
  public CsvFileRequest translationDictionary(@javax.annotation.Nullable Map<String, String> translationDictionary) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sourceLanguage, csvFileRequest.sourceLanguage) &&
        ...
        Objects.equals(this.isNeedAlignment, csvFileRequest.isNeedAlignment) &&
        Objects.equals(this.translationDictionary, csvFileRequest.translationDictionary) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceLanguage, targetLanguages, originalFileName, url, origin, isNeedAlignment, translationDictionary, savingMode, format, outputFormat, separator);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sourceLanguage", "targetLanguages", "originalFileName", "url", "origin", "isNeedAlignment", "translationDictionary", "savingMode", "format", "outputFormat", "separator"));
