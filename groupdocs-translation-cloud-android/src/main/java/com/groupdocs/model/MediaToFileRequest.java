...
public class MediaToFileRequest {
  ...
  public MediaToFileRequest url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public MediaToFileRequest isNeedAlignment(@javax.annotation.Nullable Boolean isNeedAlignment) {
  ...
  public MediaToFileRequest translationDictionary(@javax.annotation.Nullable Map<String, String> translationDictionary) {
    this.translationDictionary = translationDictionary;
    return this;
  }

  public MediaToFileRequest putTranslationDictionaryItem(String key, String translationDictionaryItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sourceLanguage, mediaToFileRequest.sourceLanguage) &&
        ...
        Objects.equals(this.isNeedAlignment, mediaToFileRequest.isNeedAlignment) &&
        Objects.equals(this.translationDictionary, mediaToFileRequest.translationDictionary) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceLanguage, targetLanguages, originalFileName, url, origin, isNeedAlignment, translationDictionary, savingMode, format, outputFormat, fragments, interval, route);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sourceLanguage", "targetLanguages", "originalFileName", "url", "origin", "isNeedAlignment", "translationDictionary", "savingMode", "format", "outputFormat", "fragments", "interval", "route"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("sourceLanguage", "targetLanguages", "url", "format", "outputFormat"));
  }
