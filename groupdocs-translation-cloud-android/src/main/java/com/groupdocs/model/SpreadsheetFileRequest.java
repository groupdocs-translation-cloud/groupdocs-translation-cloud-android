...
public class SpreadsheetFileRequest {
  ...
  public SpreadsheetFileRequest url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public SpreadsheetFileRequest isNeedAlignment(@javax.annotation.Nullable Boolean isNeedAlignment) {
  ...
  public SpreadsheetFileRequest translationDictionary(@javax.annotation.Nullable Map<String, String> translationDictionary) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sourceLanguage, spreadsheetFileRequest.sourceLanguage) &&
        ...
        Objects.equals(this.isNeedAlignment, spreadsheetFileRequest.isNeedAlignment) &&
        Objects.equals(this.translationDictionary, spreadsheetFileRequest.translationDictionary) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceLanguage, targetLanguages, originalFileName, url, origin, isNeedAlignment, translationDictionary, savingMode, format, outputFormat, worksheets, ranges);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sourceLanguage", "targetLanguages", "originalFileName", "url", "origin", "isNeedAlignment", "translationDictionary", "savingMode", "format", "outputFormat", "worksheets", "ranges"));
