...
public class ImageToFileRequest {
  ...
  public ImageToFileRequest url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public ImageToFileRequest isNeedAlignment(@javax.annotation.Nullable Boolean isNeedAlignment) {
  ...
  public ImageToFileRequest translationDictionary(@javax.annotation.Nullable Map<String, String> translationDictionary) {
    this.translationDictionary = translationDictionary;
    return this;
  }

  public ImageToFileRequest putTranslationDictionaryItem(String key, String translationDictionaryItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sourceLanguage, imageToFileRequest.sourceLanguage) &&
        ...
        Objects.equals(this.isNeedAlignment, imageToFileRequest.isNeedAlignment) &&
        Objects.equals(this.translationDictionary, imageToFileRequest.translationDictionary) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceLanguage, targetLanguages, originalFileName, url, origin, isNeedAlignment, translationDictionary, savingMode, format, ocrformat, outputFormat, rotationAngle, formatting, route, pages);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sourceLanguage", "targetLanguages", "originalFileName", "url", "origin", "isNeedAlignment", "translationDictionary", "savingMode", "format", "ocrformat", "outputFormat", "rotationAngle", "formatting", "route", "pages"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("sourceLanguage", "targetLanguages", "url", "ocrformat", "outputFormat"));
  }
