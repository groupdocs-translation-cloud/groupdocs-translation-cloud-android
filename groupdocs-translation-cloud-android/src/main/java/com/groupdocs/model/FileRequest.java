...
public class FileRequest {
  ...
  public FileRequest isNeedAlignment(@javax.annotation.Nullable Boolean isNeedAlignment) {
  ...
  public FileRequest translationDictionary(@javax.annotation.Nullable Map<String, String> translationDictionary) {
    this.translationDictionary = translationDictionary;
    return this;
  }

  public FileRequest putTranslationDictionaryItem(String key, String translationDictionaryItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sourceLanguage, fileRequest.sourceLanguage) &&
        ...
        Objects.equals(this.isNeedAlignment, fileRequest.isNeedAlignment) &&
        Objects.equals(this.translationDictionary, fileRequest.translationDictionary) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceLanguage, targetLanguages, originalFileName, url, origin, isNeedAlignment, translationDictionary, savingMode, format, outputFormat, masters, formatting, route, separator, elements, ranges, shortcodedict, frontMatterList, ignoreList, isWhiteList);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sourceLanguage", "targetLanguages", "originalFileName", "url", "origin", "isNeedAlignment", "translationDictionary", "savingMode", "format", "outputFormat", "masters", "formatting", "route", "separator", "elements", "ranges", "shortcodedict", "frontMatterList", "ignoreList", "isWhiteList"));
