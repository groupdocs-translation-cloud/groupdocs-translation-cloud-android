...
public class PresentationFileRequest {
  ...
  public PresentationFileRequest isNeedAlignment(@javax.annotation.Nullable Boolean isNeedAlignment) {
  ...
  public PresentationFileRequest translationDictionary(@javax.annotation.Nullable Map<String, String> translationDictionary) {
    this.translationDictionary = translationDictionary;
    return this;
  }

  public PresentationFileRequest putTranslationDictionaryItem(String key, String translationDictionaryItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sourceLanguage, presentationFileRequest.sourceLanguage) &&
        ...
        Objects.equals(this.isNeedAlignment, presentationFileRequest.isNeedAlignment) &&
        Objects.equals(this.translationDictionary, presentationFileRequest.translationDictionary) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceLanguage, targetLanguages, originalFileName, url, origin, isNeedAlignment, translationDictionary, savingMode, format, outputFormat, masters, slides);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sourceLanguage", "targetLanguages", "originalFileName", "url", "origin", "isNeedAlignment", "translationDictionary", "savingMode", "format", "outputFormat", "masters", "slides"));
