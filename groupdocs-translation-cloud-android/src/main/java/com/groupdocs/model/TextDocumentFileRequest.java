...
public class TextDocumentFileRequest {
  ...
  public TextDocumentFileRequest url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public TextDocumentFileRequest isNeedAlignment(@javax.annotation.Nullable Boolean isNeedAlignment) {
  ...
  public TextDocumentFileRequest translationDictionary(@javax.annotation.Nullable Map<String, String> translationDictionary) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sourceLanguage, textDocumentFileRequest.sourceLanguage) &&
        ...
        Objects.equals(this.isNeedAlignment, textDocumentFileRequest.isNeedAlignment) &&
        Objects.equals(this.translationDictionary, textDocumentFileRequest.translationDictionary) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceLanguage, targetLanguages, originalFileName, url, isNeedAlignment, translationDictionary, savingMode, format, outputFormat, preserveFormatting, origin, pages);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sourceLanguage", "targetLanguages", "originalFileName", "url", "isNeedAlignment", "translationDictionary", "savingMode", "format", "outputFormat", "preserveFormatting", "origin", "pages"));
